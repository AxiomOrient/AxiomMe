    ...
    pub(super) fn log_benchmark_run_success(
        ...
        self.log_request_status(
            ...
            Some(serde_json::json!({
                ...
                "p95_latency_us": report.p95_latency_us.map(|value| value.to_string()),
                "search_p95_latency_ms": report.search_p95_latency_ms.to_string(),
                "search_p95_latency_us": report.search_p95_latency_us.map(|value| value.to_string()),
                "commit_p95_latency_ms": report.commit_p95_latency_ms.to_string(),
                "commit_p95_latency_us": report.commit_p95_latency_us.map(|value| value.to_string()),
